...
* [User Guide](https://github.com/facebookincubator/create-react-app/blob/master/packages/preact-compat-scripts/template/README.md) – How to develop apps bootstrapped with Create React App.
